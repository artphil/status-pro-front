...
function DeckPage() {
  const baralho: CardType[] = [
    ...
    { type: 'bronze', name: 'Pisadeira', image: 'pisadeira', serie: 'A3', status: [{ label: 'size', value: 2.1 }, { label: 'peso', value: 82 }, { label: 'poder', value: 35 }, { label: 'velocidade', value: 15 }, { label: 'magia', value: 20 }] },
  ];
